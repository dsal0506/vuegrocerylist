<script setup>
  ...
  const deleteGrocery = id => {
    ...
    confetti({particalCount:3000, spread:100, origin: { y: 1 }})
  }
...
main{
  ...
  form{
    @apply m-8 flex focus-within:ring-8 focus-within:ring-accent focus-within:rounded-lg;
    input{
  ...
  ul{
    @apply flex-col items-center justify-center rounded-lg bg-comment;
    li{
